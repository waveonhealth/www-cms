...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    article_body: Schema.Attribute.RichText;
...
export interface ApiContactUsContactUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blogs: Schema.Attribute.Component<'blog.blog-slider-1', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
    faqs: Schema.Attribute.Component<'common.faq-list', false>;
...
export interface ApiFeedbackFeedback extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_provided: Schema.Attribute.Date;
    feedback_media: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    feedback_name: Schema.Attribute.String;
    header_icon: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    headline: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiTermsOfUseTermsOfUse extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    se0: Schema.Attribute.Component<'shared.seo', false>;
    terms_of_use: Schema.Attribute.RichText;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
